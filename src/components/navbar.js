            ...
            <div className='container'>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent" style={{ display: open ? "unset" : "none" }}>
                    <ul className="navbar-nav mr-auto">
                        ...
                        { /*<li className="nav-item active">
                            <a className="nav-link" style={{ marginLeft: "20px", textTransform: "uppercase", fontSize: "18px", letterSpacing: '1px', color: "#fff", cursor: "pointer" }} onClick={() => setDrop(!drop)}>Blogs</a>
                            {drop ? (
